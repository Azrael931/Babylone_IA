...
# Add an H2 title
if lang == 'Fr':
    st.markdown("<h2 style='text-align: center;'>Bienvenue sur votre Babylone</h2>", unsafe_allow_html=True)
elif lang == 'En':
    st.markdown("<h2 style='text-align: center;'>Welcome to your Babylone</h2>", unsafe_allow_html=True)

# Presentation Text
if lang == 'Fr':
    st.markdown("<p style='text-align: center;'> \
                Babylone est un assistant intelligent capable de voir 👀 écouter 👂 discuter 💬 et coder 💻 \
                vous permettant de naviguer sur le web, contrôler votre multimédia et automatiser des tâches \
                en toute simplicité. <br><br>Avec ses capacités de reconnaissance visuelle et vocale, Babylone s'adapte \
                à vos besoins pour optimiser votre productivité et enrichir votre expérience numérique.<br><br> \
                Découvrez une nouvelle façon d'interagir avec la technologie grâce à Babylone, \
                votre partenaire technologique au quotidien. ✨ \
                </p>", 
                unsafe_allow_html=True)
elif lang == 'En':
    st.markdown("<p style='text-align: center;'> \
                Babylone is an intelligent assistant capable of seeing 👀 listening 👂 conversing 💬 and coding 💻 \
                allowing you to browse the web, control your multimedia, and automate tasks with ease.<br><br> \
                With its visual and voice recognition capabilities, Babylone adapts to your needs to enhance \
                productivity and enrich your digital experience. <br><br>Discover a new way to interact with technology \
                with Babylone, your everyday tech partner. ✨ \
                </p>", 
                unsafe_allow_html=True)
